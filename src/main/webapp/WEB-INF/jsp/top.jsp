    ...
    <div class="container" >
        <div class="col-md-12" >
            ...
            <div class="navbar-collapse collapse">
                ...
                <form id="formTop" name="form1" action="${pageContext.request.contextPath}/searchItem/1" method="post" class="navbar-form navbar-left" role="search">
                    <div class="form-group">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Search" name="search" />
                            <span class="input-group-addon"><a href="javascript:formTop.submit()"><span class="glyphicon glyphicon-search"></span></a></span>
                        </div>
                    </div>
                </form>
                <ul class="nav navbar-nav navbar-right">
                	...
                	<c:if test="${username!=null }">
                		...
                		<li><a href="${pageContext.request.contextPath}/myOrder/All/1">My Order</a></li>
